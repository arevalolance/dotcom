    ...
    <>
      <section className="h-[85vh] flex flex-col items-center justify-between">
        ...
        <div className="flex flex-col justify-center items-center">
          <span className="font-space-grotesk text-[18px]">
            learn more
          </span>
      ...
      <section className="m-auto h-[100vh] flex flex-col justify-center font-space-grotesk">
        <div className="flex flex-row items-center">
          <span className="text-[24px]">about</span>
          <div className="min-w-[70vw] bg-white max-h-[2px]" />
        </div>
        <p className="text-[14px] mt-5">
          My passion for building helpful and exciting technology for
          the people brought me to Saint Louis University, where I
          study B.S. Computer Science. I&apos;m a third-year computer
          science student and future web developer with experience in
          full-stack development and front-end design.
        </p>
        <br />
        <p className="text-[14px] mt-5">
          Currently, I focus on back-end web development, building
          API&apos;s for my projects. This site is still a work in
          progress and will be a place to see how I&apos;ll grow as a
          developer.
        </p>
        ...
        {/* <div className="mt-10">
          <span className="text-[24px] mt-10 ">latest blogs</span>
          <ul>
            <li>
              <span className="text-[14px] hover:cursor-pointer hover:underline">
                lorem ipsum title
              </span>
              <span className="text-[9px] text-[#C0C0C0] ml-5">
                mm/dd/yy
              </span>
            </li>
          </ul>
