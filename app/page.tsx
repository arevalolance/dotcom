    ...
    <main className="container mx-auto">
      <div className="my-40">
        <div className="max-w-[740px]">
          ...
          <h1 className="bg-gradient-to-br from-black to-stone-500 text-transparent text-center md:text-left bg-clip-text font-display text-4xl font-bold tracking-[-0.02em] drop-shadow-sm md:text-7xl md:leading-[5rem]">
